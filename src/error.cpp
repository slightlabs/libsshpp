...
const std::error_category& ssh_category() noexcept {
    static const SshCategory instance;
    return instance;
}

const std::error_category& sftp_category() noexcept {
    static const SftpCategory instance;
    return instance;
}

std::error_code make_error_code(errc e) noexcept { return {static_cast<int>(e), ssh_category()}; }
std::error_code make_error_code(sftp_errc e) noexcept { return {static_cast<int>(e), sftp_category()}; }
...
void throw_error(ErrorInfo info) {
