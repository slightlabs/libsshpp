...
// Generated from src/session_options.cpp; see docs/design/09 §9.3.
...
SSHPP_INLINE Result<void> SessionOptions::validate() const {
    if (host.empty()) {
        ErrorInfo info;
...
SSHPP_INLINE Result<SessionOptions> SessionOptions::parse_target(std::string_view target) {
    SessionOptions opts;
