...
// Generated from src/server_bind.cpp; see docs/design/09 §9.3.
...
SSHPP_INLINE Result<void> BindOptions::validate() const {
...
SSHPP_INLINE Bind::Bind(const BindOptions& opts) : configured_port_(opts.port) {
...
SSHPP_INLINE Result<void> Bind::try_listen() {
...
SSHPP_INLINE int Bind::fd() const noexcept { return native_ != nullptr ? static_cast<int>(ssh_bind_get_fd(native_)) : -1; }

SSHPP_INLINE Result<Session> Bind::try_accept() {
...
SSHPP_INLINE Result<std::optional<Session>> Bind::try_accept(std::chrono::milliseconds timeout) {
    if (native_ == nullptr) return ErrorInfo{make_error_code(errc::invalid_handle), "", "Bind::try_accept"};
